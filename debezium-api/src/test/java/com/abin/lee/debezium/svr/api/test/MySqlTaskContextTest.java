 ...
 */
package com.abin.lee.debezium.svr.api.test;

import com.abin.lee.debezium.svr.api.client.Testing;
...
//                Testing.Files.delete(DB_HISTORY_PATH);
    ...
    protected Configuration.Builder simpleConfig() {
        String hostname = "172.1.6.2.133" ;
        String port = "3306" ;
        String username = "debezium" ;
        String password = "dbz" ;
        String serverId = "1" ;
        String serverName = "deal" ;
        String databaseName = "deal" ;

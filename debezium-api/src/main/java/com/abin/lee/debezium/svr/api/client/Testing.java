...
//                    Object object= (Object)("Will not remove directory that is outside test target area: ", path);
//                    printError(object);
                    printError("Will not remove directory that is outside test target area: ", new Throwable(""));
                }
            }
        }
